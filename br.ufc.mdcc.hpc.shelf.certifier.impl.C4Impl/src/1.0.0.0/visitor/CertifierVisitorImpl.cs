...
using System;
//using br.ufc.mdcc.hpcshelf.certifier.impl.computation.CertfierImpl.logic;
using br.ufc.mdcc.hpcshelf.certifier.impl.computation.CertfierImpl.visitor.logic;
namespace br.ufc.mdcc.hpcshelf.certifier.impl.computation.CertfierImpl.visitor{



public class CertifierVisitorImpl : C4ImplVisitor{

	//logic package.
		private String logicPkg = "br.ufc.mdcc.hpcshelf.certifier.impl.computation.CertfierImpl.visitor.logic";
